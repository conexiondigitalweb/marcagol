    ...
    <div className="animate-slide-up max-w-3xl mx-auto">
      ...
      <div className="mb-4 flex gap-2">
        ...
        <button
          ...
          className={`flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-bold text-sm text-white transition-opacity hover:opacity-90 active:opacity-75 ${!isMatchStarted ? '' : 'w-full'}`}
